        ...
        <>
            <div className="flex flex-col gap-15 mx-30 py-27">
                <div className="flex flex-row items-center gap-20">
                    ...
                    <img src={heroImg} alt="Project header" className="hover:rotate-2 transition-transform max-w-7/12 rounded-2xl"></img>
                </div>
                <div className='flex flex-row gap-10 justify-between'>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <div>
                            {team.map(team => <p key={team} className=''>{team}</p>)}
                        </div>
                    </div>
                    <div className='flex flex-col gap-3'>
                        <h3 className="uppercase text-neutral-400 font-light">Skills</h3>
                        <div>
                            {skills.map(skills => <p key={skills} className=''>{skills}</p>)}
                        </div>
                    </div>
