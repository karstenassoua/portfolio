...
const Card = ({ image, projectName, url, skills, description, isAwarded, projectLink }) => {
    return (
        <a href={url} className="flex flex-col w-8/16 mx-2 my-2 transition-transform duration-300 hover:scale-102">
          <div className="">
                {/* Image Section */}
                <div className="h-80">
                    <img
                ...
                <div className="p-4 flex-wrap">
                    ...
                    <div className="flex flex-row gap-5 text-sm text-neutral-500 mb-3">
